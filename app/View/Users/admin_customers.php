 ...
 */
$title_for_layout = isset($title_for_layout) ? $title_for_layout : "Members";
?>
            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="action-buttons text-center">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <a class="btn grey" href="<?= $this->Html->url(array("action" => "admin_customers")) ?>">Clear</a>
                    </div> 
                </div>
            </div>
        </div>
        ...
        <table class="table table-striped table-bordered order-column" id="sample_1_2">
            <thead>
                <tr>
                    ...
                    <th style="width : 8%;"> <?= $this->Paginator->sort('is_premium', __('Premium')); ?> </th>
                    <th style="width : 8%;"> <?= $this->Paginator->sort('is_active', __('Active')); ?> </th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="odd gradeX center">
                    ...
                    <td>
                        <i class="fa <?= $record[$model]['is_premium'] ? "fa-check-circle-o font-green-meadow icon" : "fa-times-circle-o font-red-sunglo icon" ?>"></i>
                    </td>
                    <td>
