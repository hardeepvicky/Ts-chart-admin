...
jQuery.fn.extend({
    ...
    cssSelector : function(opt)
    {
        return this.each(function()
        {
            var _this = $(this);
            
            if (_this.hasClass("cssSelector-applied"))
            {
                return true;
            }
            
            _this.addClass("cssSelector-applied");
            
            var item_select = _this.attr("data-selector-target-item");
            var select_class = _this.attr("data-selector-class");
            
            _this.on("click", item_select, function()
            {
                $(item_select).removeClass(select_class);
                $(this).addClass(select_class);
                
                var v = $(this).attr("value");
                _this.attr("value", v);
                
                if (typeof opt != "undefined" && typeof opt.onSelect == "function")
                {
                    opt.onSelect(v);
                }
            });
            ...
            {
                _this.find(item_select).each(function ()
                {
